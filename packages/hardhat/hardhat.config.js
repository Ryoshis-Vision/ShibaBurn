...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      ...
      accounts: [`${process.env.TEST_DEPLOYER_PRIV_KEY}`],
      gas: 2100000,
      gasPrice: 8000000000
    },
    // kovan: {
...
extendEnvironment((hre) => {
	const etherscanAbi = require("hardhat-etherscan-abi");
  const Web3 = require("web3");
  hre.Web3 = Web3;
  // hre.network.provider is an EIP1193-compatible provider.
  hre.web3 = new Web3(hre.network.provider);

	hre.getVerifiedContractAt = etherscanAbi.getVerifiedContractAt;
});
